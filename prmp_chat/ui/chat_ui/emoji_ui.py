...
_EMOJI_SPRITE_SHEET = r'C:\Users\Administrator\Coding_Projects\Icons\Emojis\sprite_sheets\sheet_%s_64.png'
...
class Emoji_Sprite:
    ...
    @property
    def ww(self): return self.sprite_image.width()/60
    @property
    def _ww(self): return self.sprite_image.width()
    @property
    def _hh(self): return self.sprite_image.height()
    @property
    def hh(self): return self.sprite_image.height()/60
