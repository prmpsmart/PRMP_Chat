...
"")
        ...
        self.usernameLabel.setGeometry(QRect(100, 40, 141, 21))
        font2 = QFont()
    ...
    def retranslateUi(self, SideDialog):
        ...
        self.lastLoginLabel.setText(QCoreApplication.translate("SideDialog", u"last login 2021/06/25 at 06:11 PM", None))
        self.nameLabel.setText(QCoreApplication.translate("SideDialog", u"Apata Miracle Peter", None))
        self.usernameLabel.setText(QCoreApplication.translate("SideDialog", u"prmpsmart", None))
