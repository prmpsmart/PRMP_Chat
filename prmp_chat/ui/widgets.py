...
import os, re, emoji
from prmp_chat.ui.text_parser import TextParser
from prmp_chat.ui.emoji_ui import EmojiWidget
from prmp_chat.new_ui.chat_ui import *
from . import resources

def SETUP_FRAME(mother_layout=None, orient='v', margins=[], obj=None, re_obj=0, space=0):
...
class Scrolled_Widget(QScrollArea):
    def __init__(self, orient='v'):
        ...
        self._layout = SETUP_FRAME(obj=self._widget, orient=orient)
    ...
    def set_widget(self, widget):
        ...
        if self.orient == 'v': self.verticalScrollBar().rangeChanged.connect(self.scroll_down)
