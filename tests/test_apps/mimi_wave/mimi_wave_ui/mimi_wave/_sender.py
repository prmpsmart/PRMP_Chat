...
from ._app import *
from ._app import _WaveWidget


class _WaveSender(_WaveWidget):
    def __init__(self, *args, title="Wave Sender", **kwargs):
        super().__init__(title=title, *args, **kwargs)

        self.serving = False
        self.wave_recorder = WaveRecorder(callback=self.recording)
        self.frames = self.wave_recorder.frames
        self.clients: List[socket] = []

        self._record: _Widget = None
        self._stop_recording: _Widget = None
        self._start_server: _Widget = None
        self._stop_server: _Widget = None
        self._send_recorded: _Widget = None
