...
from .app_tk import *
from .app_tk import _WaveSender
...
class WaveSender(WaveWidgetCommon, _WaveSender):
    ...
    def __init__(self, app: WaveApp, title="Wave Sender"):
        _WaveSender.__init__(self, app=app, title=title, geo=(250, 200, 50, 50))
        WaveWidgetCommon.__init__(self, app)
    ...
    def setup(self):
        ...
        WaveWidgetCommon.setup(self, (recording_box, recording_box, transfer_box))
